...
namespace MediaLibraryServer.Services
{
    public class FileProcessorService : IFileProcessorService, IDisposable
    {
        ...
        private bool firstTimeStatup = true;
            ...
            IFolderService folderService)
        {
            ...
            fileWatcherTimer = new Timer(10000);
        ...
        private void RecoverInterimFiles()
        {
            try
            {
                logger.LogInformation("Checking for files stuck in the interim folder");
            ...
            {
                logger.LogError("Failed to start File Processor Service", ex);
            }
        }
