                        ...
                        if (newFolders.length > 0) {
                            newFolders.forEach((newFolder) => {
                                ...
                                if (oldFolderIndex == -1) {
                                    ...
                                    JSON.stringify(
                                        this.oldModel.folders[oldFolderIndex]
                                    )
                                ) {
    ...
    private UpdateConfig() {
        if (this.mainConfig) {
            this.configService
                ...
                .pipe(
                    map((ii) => {
                        ;(this.model.folders as FolderLibrary[]).forEach(
                            (folder) => {
